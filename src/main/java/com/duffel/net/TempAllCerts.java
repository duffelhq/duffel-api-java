 ...
 */
public final class TempAllCerts implements X509TrustManager, HostnameVerifier
{
    ...
    /**
     * Installs a new {@link TempAllCerts} as trust manager and hostname verifier.
     */
    public static void install()
    {
        try
        {
            TempAllCerts trustAll = new TempAllCerts();
